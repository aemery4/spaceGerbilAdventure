...
const P5_ALIEN_POOL = [
  ...
  { name: 'Grumbo', emoji: '🤖', color: '#aaaaaa', dialog: 'BEEP BOOP. I have traveled 47 galaxies. This base is... adequate.', shape: 'bot' },
  ...
  { name: 'Zog',    emoji: '👁️', color: '#88ff44', dialog: 'I see all with my one big eye. And I see... you need a friend!', shape: 'blob' },
  { name: 'Mim',    emoji: '🌙', color: '#c0c0ff', dialog: 'Hehe! Wanna play a quick game? I never lose... probably.', minigame: true },
  { name: 'Kr-7',   emoji: '🛰️', color: '#9ab0c0', dialog: 'SCANNING... life-form detected: adorable. Reporting to the fleet.', shape: 'bot' },
  ...
  { name: 'Gloop',  emoji: '👻', color: '#b0ffe0', dialog: 'Boo! Just kidding — space ghosts are friendly. Love the company!', shape: 'ghost' },
  ...
  { name: 'Bit',    emoji: '🎮', color: '#4affea', dialog: 'Beep! I am 8-bit and 100% fun. Challenge me to a game?', minigame: true, shape: 'bot' },
  { name: 'Puff',   emoji: '☁️', color: '#dfeaff', dialog: 'I am a cloud-being from Nimbus-9. So fluffy, so friendly.', shape: 'ghost' },
];
